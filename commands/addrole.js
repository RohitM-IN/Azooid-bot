...
exports.run = async (client, message, args) => {
    ...
    const sChannel = message.guild.channels.cache.find(ch => ch.name.includes('member-log')) || message.guild.channels.cache.find(ch => ch.name.includes('log')) || message.guild.channels.cache.find(ch => ch.name.includes('logs'));
    sChannel.send(embed);
}
